...
public interface ISCMAdapter extends IServiceAdapter
{
    ...
    /**
     * Create an SCM project / container for various component repositories
     ...
     * to derive the names from. The name of the component can be found as option in the map
     * with key being {@link OpenProjectData#COMPONENT_ID_KEY}
     * @return a Map with key being the key for the repo and a map with the repo links
    ...
    /**
     * Create the repository name from the component's name. This is super important,
     * as it's the only way for us to know which repo belongs to which component. 
