...
/**
 * In line with
 * https://docs.atlassian.com/jira/REST/server/#api/2/project-getProject to
 * allow use of given jira classes from Jira Rest Client lib but still let us
 * create a new project, we need to expand the already existing one with
 * properties that they left out
 *
...
public class FullJiraProject extends Project
{
    ...
    public FullJiraProject(URI self, String key, String name,
            String description, BasicUser lead, URI uri,
    ...
    {
        super(self, key, name, description, lead, uri, versions,
                components, issueTypes, projectRoles);
